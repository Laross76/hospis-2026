...
public class AboutPage {
    ...
    public void assertAppLabelIsVisible() {
        Allure.step("Проверка отображения лейбла приложения");
    ...
    public void clickOnPrivacyPolicy() {
        ...
        verifyIntent(Data.PRIVACY_POLICY_URL);
    }
    ...
    public void clickOnTermsOfUse() {
        ...
        verifyIntent(Data.TERMS_OF_USE_URL);
    }
